...
class HappinessTracker(QWidget):
    ...
    def init_ui(self):
        ...
        admin_button.clicked.connect(self.show_admin_message)

        member_button = QPushButton("Member")
        member_button.clicked.connect(self.start_questionnaire)

        start_layout.addWidget(welcome_label)
        start_layout.addWidget(admin_button)
        start_layout.addWidget(member_button)
